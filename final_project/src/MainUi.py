...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_button_6 = QtWidgets.QPushButton(qtawesome.icon('fa.database', color='white'), "sql")
        self.left_button_6.setObjectName('left_button')
        self.left_button_7 = QtWidgets.QPushButton(qtawesome.icon('fa.code', color='white'), "开发者模式")
        self.left_button_7.setObjectName('left_button')
        self.left_button_8 = QtWidgets.QPushButton(qtawesome.icon('fa.github', color='white'), "关注我们")
